        ...
        <div style={styles.modalOverlay} onClick={() => setShowDeleteModal(false)}>
          <div style={styles.confirmModal} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={styles.modalButtons}>
              ...
              <button style={styles.confirmButton} onClick={handleDeleteAll}>
                Clear All
              </button>
            </div>
          </div>
      ...
      {confirmDeleteId && createPortal(
        <div style={styles.modalOverlay} onClick={() => setConfirmDeleteId(null)}>
          <div style={styles.confirmModal} onClick={(e) => e.stopPropagation()}>
            ...
            <p style={styles.modalMessage}>
              Are you sure you want to delete this detection log? This cannot be undone.
            </p>
            <div style={styles.modalButtons}>
              <button style={styles.cancelButton} onClick={() => setConfirmDeleteId(null)}>
                Cancel
              </button>
              <button
...
const styles = {
  ...
  clearButton: {
    ...
    backgroundColor: '#ecf0f1', color: '#7f8c8d', fontSize: '14px',
  ...
  filterPanel: {
    ...
    display: 'grid', gridTemplateColumns: '1fr 1fr 2fr', gap: '24px',
  },
  ...
  th: {
    padding: '15px', textAlign: 'left', backgroundColor: '#f8f9fa',
    color: '#2c3e50', fontWeight: '600', fontSize: '13px',
  ...
  thumbnail: {
    ...
    borderRadius: '6px', cursor: 'pointer', border: '2px solid #e0e0e0',
  },
  noImage: {
  ...
  typeBadge: {
    padding: '4px 10px', backgroundColor: '#fee', color: '#c33',
    borderRadius: '6px', fontSize: '12px', fontWeight: '600', textTransform: 'capitalize',
  },
  confidenceBadge: {
    padding: '4px 10px', backgroundColor: '#e8f5e9', color: '#2e7d32',
  ...
  notes: { fontSize: '13px', color: '#7f8c8d' },
  deleteRowButton: {
    display: 'flex', alignItems: 'center', gap: '5px',
    padding: '6px 12px', backgroundColor: '#fff0f0',
    color: '#e74c3c', border: '1px solid #fcc',
  ...
  modalContent: {
    position: 'relative', maxWidth: '80%', maxHeight: '80vh',
    display: 'flex', alignItems: 'center', justifyContent: 'center',
  },
  closeButton: {
    ...
    alignItems: 'center', justifyContent: 'center',
    cursor: 'pointer', zIndex: 100000, boxShadow: '0 2px 8px rgba(0,0,0,0.4)',
  },
  ...
  cancelButton: {
    padding: '12px 24px', backgroundColor: '#ecf0f1', border: 'none',
    borderRadius: '8px', color: '#2c3e50', fontSize: '15px', fontWeight: '600', cursor: 'pointer',
  },
  confirmButton: {
    padding: '12px 24px', backgroundColor: '#e74c3c', border: 'none',
    borderRadius: '8px', color: '#ffffff', fontSize: '15px', fontWeight: '600', cursor: 'pointer',
  },
};
